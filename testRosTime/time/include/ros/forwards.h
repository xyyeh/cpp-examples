...
class TimerHandle;
typedef boost::shared_ptr<TimerHandle> TimerHandlePtr;
...
struct SteadyTimerEvent {
  ...
  SteadyTime current_real;      ///< This is when the current callback was actually called (SteadyTime::now() as of the
